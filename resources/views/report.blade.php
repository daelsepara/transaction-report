							...
							<tbody>
								...
								<?php foreach ($transactions as $transaction) : ?>
									<tr>
										...
										?>
										<th scope="col">
											<p class="text-info text-center">{{$percentage > 0 ? $percentage.'%' : ''}}</p>
										</th>
								...
								<tr>
									...
									<th scope="col">
										<p class="text-primary text-right">$ {{number_format($page_total, 2)}}</p>
									</th>
									<th scope="col">
										<p class="text-secondary text-right">Commissions</p>
									</th>
									<th scope="col">
										<p class="text-success text-right">$ {{number_format($commissions, 2)}}</p>
									</th>
									<th scope="col"></th>
								</tr>
							</tbody>
		...
		$(document).ready(function() {
			...
			$('input.typeahead').typeahead({
				...
				source: function(query, process) {
					...
					return $.get('/commissions/autocomplete', {
						q: query
					}, function(data) {
						data = $.parseJSON(data);
