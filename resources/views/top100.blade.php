					...
					<table class = "table table-striped table-bordered">
						...
						<?php foreach($distributors as $distributor): ?>
							<tr>
								...
								<th scope="col"><p class = "text-primary">{{$distributor->Distributor}}</p></th>
								<th scope="col" class = "text-right"><p class = "text-success">$ {{number_format($distributor->OrderTotal, 2)}}</p></th>
